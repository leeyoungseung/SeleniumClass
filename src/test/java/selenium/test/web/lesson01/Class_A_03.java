...
public class Class_A_03 {
	...
	public void Test002() throws IOException, WebDriverException{
		...
		//WebElement wel2 = driver.findElement(By.className("table table-bordered")); -> 중간에 뛰어쓰기가 있는 것은 인식을 못함ㄷㄷ
		System.out.println(wel.getAttribute("class"));
		
		//선택한 WebElement의 부모 요소를 지정하기
		//참조 : https://stackoverflow.com/questions/24267413/how-to-get-parent-of-webelement
		// xpath를 이용한 방법
